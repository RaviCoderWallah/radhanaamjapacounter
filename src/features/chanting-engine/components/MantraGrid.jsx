      ...
      {mantras.map((mantra) => (
        ...
        >
          ...
          <div className="relative w-full overflow-hidden h-[200px]">
            ...
            />
            {/* Gradient overlay */}
            <div className="absolute inset-0 bg-gradient-to-t from-[#F37420]/55 via-transparent to-transparent opacity-90" />
            {/* Deity name on image */}
            <span
          ...
          <div className="p-5 flex flex-col gap-3">
            <h2 className="text-xl font-bold leading-snug text-[#F37420]">
              {mantra.name}
            </h2>
            <p className="paragraph-text leading-relaxed font-medium text-xs sm:text-sm text-[#7a5c2e]">
              {mantra.description}
            </p>
            ...
            <Link
              ...
              style={{
                background: "linear-gradient(135deg, #F37420 0%, #F9BB4D 100%)",
